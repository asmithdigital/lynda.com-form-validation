...
if (($_SERVER['REQUEST_METHOD'] == 'POST') && (!empty($_POST['action']))):
	...
	if (!($formerrors)):
		...
		$saveddate = date("mdy-Hms"); // keep the file names unique with a date, to avoid writing over the file by each user upload
		$newfilename = "uploads/".$saveddate."_".$uploadfilename; // joining the date and file name
