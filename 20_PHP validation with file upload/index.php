...
<!-- checks form submit, shows message and then hides the form -->
<?php 
if (isset($msg)) :
...
<form id="myform" name="theform" class="group" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data"> <!-- file upload correct type -->
